...
#But we can't tell what is the upper and lower jaw
...
#now let's compute the distances between mean groups in space defined by dis.functions
...
#due to just 2 clusters, upper and lower jaw type. 
...
jaw is better to distinguish among species. 
...
upper jaw across 3 species and their deviation away from the mean shape. 
